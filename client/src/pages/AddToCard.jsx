...
import { ArrowLeft, X, Plus, Minus, Trash2, TrendingUp, Leaf, MapPin, Check, ShoppingCart } from 'lucide-react';
...
export default function CartPage() {
  ...
  const [cartItems, setCartItems] = useState([
    ...
    },
    {
      ...
      unit: 'kg',
      quantity: 3,
      images: ['https://images.unsplash.com/photo-1592924356763-7fbd308014c5?w=300'],
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <p className="text-sm text-gray-600 mb-2">{item.farmerName}</p>
                        <p className="text-xs text-gray-500 flex items-center gap-1 mb-3">
                          <MapPin size={12} /> {item.distance} km away
                        </p>
